...
extension Color {
    ...
    public static let dardGreen = Color(red: 39, green: 174, blue: 96)
    public static let lightPurple = Color(red: 155, green: 89, blue: 182)
    public static let dardPurple = Color(red: 142, green: 68, blue: 173)
    ...
    public static let dardYellow = Color(red: 243, green: 156, blue: 18)
    public static let lightOrange = Color(red: 230, green: 126, blue: 34)
    public static let darkOrange = Color(red: 211, green: 84, blue: 0)
    public static let PurpleBackground = Color(red: 69, green: 51, blue: 201)
}
